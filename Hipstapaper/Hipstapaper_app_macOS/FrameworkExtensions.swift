...
extension NSMenuItem {
    enum Kind: Int {
        case open = 999, openInBrowser = 998, copy = 444, archive = 555, unarchive = 544, delete = 666, share = 898, shareSubmenu = 897, javascript = 433, showMainWindow = 374, tags = 909, quickLook = 764, migrate = 626
    }
}
